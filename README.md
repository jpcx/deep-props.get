# [deep-props](https://github.com/jpcx/deep-props/blob/develop/README.md).get
...
**Usage of a custom extraction function (see [<code>Options</code>](https://github.com/jpcx/deep-props.get/blob/develop/docs/global.md#~Options) and [<code>GetCustomizer</code>](https://github.com/jpcx/deep-props.get/blob/develop/docs/global.md#~GetCustomizer))**
```js
...
### See:
* [API Docs](https://github.com/jpcx/deep-props.get/blob/develop/docs/API.md)
* [Global Docs](https://github.com/jpcx/deep-props.get/blob/develop/docs/global.md)
...
Versioned using [SemVer](http://semver.org/). For available versions, see the [Changelog](https://github.com/jpcx/deep-props.get/blob/develop/CHANGELOG.md).
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/jpcx/deep-props.get/blob/develop/LICENSE) file for details
